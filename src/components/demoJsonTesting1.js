      ...
      phoneAssets: [
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                { "start": 0.00, "end": 4, "text": "ISG Smartmerchant is an all purpose payment acceptance application," },
                { "start": 4, "end": 10, "text": "otherwise known as omnichannel. Popular modes of payment like QR payments," },
                { "start": 10, "end": 15, "text": "contact less or tap and pay using credit, debit and prepaid cards"},
        ...
        },
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                { "start": 0.00, "end": 4, "text": "Select Payment Acceptance to know more!" },
              ],
          },
        },
        // {
      ...
      phoneAssets: [
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                ...
                { "start": 7, "end": 13, "text": "Your customers can use Tap & Pay feature for purchasing up to a value of ₹5000." },
        ...
        },
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                ...
                { "start": 4, "end": 7, "text": "Using quick reach codes or QRCs" },
        ...
        },
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                { "start": 0.00, "end": 5, "text": "Once UPI QR is selected, a static QRC will appear," },
        ...
        },
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                { "start": 0.00, "end": 4, "text": "Customers can scan on their mobile phones and pay." },
              ],
          },
        },
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                ...
                { "start": 3, "end": 7, "text": "you would click on 'Collect Request',fill the customer VPA," },
                { "start": 7, "end": 10, "text": "the amount and when the payments need to be complete" },
              ],
          },
        },
        {
      ...
      phoneAssets: [
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                ...
                { "start": 4, "end": 9, "text": "You can send request via SMS or email. Click 'SMS Pay'," },
        ...
        },
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                ...
                { "start": 4, "end": 9, "text": "to whom you offer goods as per agreed payment cycles " },
              ],
          },
        },
        {
          ...
          subsVideo: {
            audio: rtp4Audio,
            subtitles:[
                { "start": 0.00, "end": 5, "text": "Also it gives visibility of all your debtors in one platform" },
      ...
      phoneAssets: [
        {
          ...
          subsVideo: {
            ...
            subtitles:[
                ...
                { "start": 3, "end": 8, "text": "and has the option to select single or multiple terminal ID's to view collections." },
      ...
      phoneAssets: [
        {
          ...
          subsVideo: {
            audio: refund1Audio,
            subtitles:[
                { "start": 0.00, "end": 5, "text": "There's also full or parital refund for successful transactions," },
              ],
          },
        },
        {
