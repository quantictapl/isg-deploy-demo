...
function AppDemonstration({
  ...
  useEffect(()=>{
    const audio=subsVideoRef.current;
    audio.volume=volumeSliderValue;
  },[volumeSliderValue])
  return (
    <div
      ...
      >
        <a-entity id="camera-rig" position="0 0 0" ref={cameraRotationRef}>
          ...
          >
            ...
            <a-entity
              id="phone-light-3"
              light="type: spot; castShadow: true; intensity: 0.4; distance: 200; color: #ffffff; penumbra: 1; angle: 40; groundColor: #ffffff; shadowCameraRight: 7.22; decay: -0.33"
              position="0.02127 -1.26743 -0.60992"
              rotation="84.09874516930223 -133.66303219488924 -122.26976643871281"
              scale="0.2 0.2 0.2"
            ></a-entity>
            {assetsVisible && (
              <>
