...
function AppDemonstration({esy,esyHand,smartmerchant,appHandSingle,appHandPanSingle,appHandCardSingle}) {
  console.log(esy)
  ...
  useEffect(() => {
    ...
    const handleVideoPlay = () => {
      ...
      if (currentDivision === "nullAssets1" && currentPhoneAssetIndex === 1) {
        ...
        dummyEsyHandVideo.currentTime=0.00;
      }
      setIsPlaying(true);
    };
      ...
      >
        ...
        <a-entity
          ...
          scale={
            ((currentDivision === "nullAssets" &&
              currentPhoneAssetIndex === 1) ||
            (currentDivision === "nullAssets1" && currentPhoneAssetIndex === 1)) && !esyHandLoaded 
              ? "2.747 3.077 2.600"
              : "0 0 0"
          }
