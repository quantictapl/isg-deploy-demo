...
function AppDemonstration({esy,esyHand,smartmerchant}) {
  console.log(esy)
  ...
  return (
    <div className="scene-container" onClick={()=>{setMute(false)}}>
      ...
      <div class="smart-dropdown" ref={dropDownTriggerRef} onClick={handleDropdownClick}>
        ...
        >
          <span className="smart-dropdown-title appdemo-dropdown-title">Select Demo</span>
        </div>
        <div
          id="dropdown-options"
      ...
      >
        ...
        <Entity primitive="a-sky" src="#smartapp-bg" rotation="0 -130 0" />
