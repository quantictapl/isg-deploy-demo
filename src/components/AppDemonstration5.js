...
function AppDemonstration() {
  ...
  useEffect(() => {
    ...
    audio.addEventListener("canplay", handleAudioLoadedMetadata);
    video.addEventListener("canplay", handleAudioLoadedMetadata); // Added event listener to subsVideoRef as well
    video.addEventListener("ended", handleVideoEnded);
    video.addEventListener("ended", handleAudioEnded);
    return () => {
      video.removeEventListener("play", handleVideoPlay);
      video.removeEventListener("pause", handleVideoPause);
      audio.removeEventListener("canplay", handleAudioLoadedMetadata);
      audio.removeEventListener("play", handleAudioPlay);
      audio.removeEventListener("pause", handleAudioPause);
      audio.removeEventListener("ended", handleAudioEnded);
      video.removeEventListener("canplay", handleAudioLoadedMetadata); // Removed event listener for subsVideoRef
    };
