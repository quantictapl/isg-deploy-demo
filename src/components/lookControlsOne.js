 ...
 */
module.exports.Component = registerComponent('look-controls-one', {
  ...
  */
  ...
  onMouseMove: function (evt) {
    ...
    var newXRotation = pitchObject.rotation.x + (movementY * 0.002 * direction);
    newXRotation = Math.max(-Math.PI / 2, Math.min(Math.PI / 2, newXRotation)); // Limit rotation between -90 and 90 degrees
    pitchObject.rotation.x = newXRotation;
  },
